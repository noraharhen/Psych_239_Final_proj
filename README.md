...
<em><br>Figure 1. A sample of images of exemplars input into the networks for typicality and similarity ratings. A range is shown from the most typical to the least typical exemplars as identified by human participants. </em>
<p>
...
<img src="typicality_ratings-01.png"
     ...
     height=400
     style="float: left; margin-right: 10px;" />
<em><br>Figure 2. For each network and each category, the network's typicality ratings are plotted against the average human subject typicality ratings. The line is surrounded by a 95% CI. </em>
<p>
...
<img src="typicality_ratings-02.png"
     ...
     height=400
     style="float: left; margin-right: 10px;" />
<em><br>Figure 3. For each network and each category, the network's similarity ratings for each pairing of exemplars are plotted against the average human subject similarity ratings. The line is surrounded by a 95% CI. </em>
<p>
